...
- Execution venues and account rules are selected up front, before you start trading.
...
<CardGroup cols={3}>
  ...
  <Card title="Customized vaults" icon="vault">
    The product brief positions future capital allocation and customized capital access as part of the longer-term Doji journey.
  </Card>
</CardGroup>
