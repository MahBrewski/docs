...
<Steps>
  ...
  <Step title={<span style={{color: "#B7FF00"}}>Ignore direct messages</span>}>
    ...
    <CardGroup cols={1}>
      <Card icon="key-skeleton" iconType="duotone">Do not share wallet keys or passwords</Card>
      <Card icon="message-slash" iconType="duotone">Do not trust unsolicited DMs</Card>
      <Card icon="circle-dollar-to-slot" iconType="duotone">Do not send funds to anyone claiming to be support</Card>
    </CardGroup>
  ...
  <Step title={<span style={{color: "#B7FF00"}}>Open a support ticket</span>}>
    ...
    <CardGroup cols={2}>
      ...
      <Card icon="layout-dashboard" title="Dashboard bugs">UI errors or incorrect data display</Card>
