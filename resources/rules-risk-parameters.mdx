...
<CardGroup cols={2}>
  ...
  <Card icon="triangle-exclamation" title="Maximum Drawdown">Absolute equity floor for the account</Card>
...
<div style={{margin: "16px 0 24px"}}>
  {[
    ["Trailing", "The floor moves up with your equity, locking in at your all-time high. It never resets downward.", "Degen"],
...
<div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", margin: "16px 0"}}>
  <div style={{border: "1px solid rgba(255,255,255,0.08)", borderRadius: "8px", padding: "16px 20px"}}>
    <div style={{fontSize: "11px", color: "rgba(255,255,255,0.4)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "10px"}}>Degen</div>
    <div style={{display: "flex", justifyContent: "space-between", alignItems: "flex-end"}}>
      <div>
        <div style={{fontSize: "28px", fontWeight: "700", color: "#B7FF00", lineHeight: 1}}>5%</div>
        <div style={{fontSize: "12px", color: "rgba(255,255,255,0.5)", marginTop: "4px"}}>Trailing · Max drawdown</div>
      </div>
...
Daily drawdown limits reset every 24 hours based on account equity snapshots.
...
Hedging on the same currency pair is prohibited unless the hedging add-on is enabled.
